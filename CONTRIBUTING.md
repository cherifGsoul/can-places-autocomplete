# Contributing to can-places-autocomplete

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/cherifGsoul/can-places-autocomplete) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-places-autocomplete, you can start by going to its [fork page](https://github.com/cherifGsoul/can-places-autocomplete/fork).
